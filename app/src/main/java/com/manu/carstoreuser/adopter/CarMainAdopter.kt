...
import com.manu.carstoreuser.databinding.ItemMainCarBinding
import com.manu.carstoreuser.model.CarModel
import com.manu.carstoreuser.utils.Utils

class CarMainAdopter(
    val context: Context, private val carList: ArrayList<CarModel>,
    private val favoriteList: ArrayList<String>
):
RecyclerView.Adapter<CarMainAdopter.CarVH>(){

    private val auth = FirebaseAuth.getInstance()
    private val db = FirebaseFirestore.getInstance()

    inner class CarVH(val binding: ItemMainCarBinding): RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CarVH {
        val binding = ItemMainCarBinding.inflate(LayoutInflater.from(context), parent, false)
